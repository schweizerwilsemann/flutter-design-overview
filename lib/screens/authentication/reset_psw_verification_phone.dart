...
class ResetPasswordVerificationPhoneScreen extends StatefulWidget {
  final String fullPhoneNumber;

  const ResetPasswordVerificationPhoneScreen(
      {super.key, required this.fullPhoneNumber});

  @override
  State<ResetPasswordVerificationPhoneScreen> createState() =>
      ResetPasswordPhone_VerificatioCodenScreenState();
}

class ResetPasswordPhone_VerificatioCodenScreenState
    extends State<ResetPasswordVerificationPhoneScreen> {
