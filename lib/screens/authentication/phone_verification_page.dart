...
import 'package:my_practice/screens/authentication/verification_phone.dart';

class VerificationPhoneScreen extends StatefulWidget {
  const VerificationPhoneScreen({Key? key}) : super(key: key);
  ...
  void _continueToNextScreen() {
    ...
    if (fullPhoneNumber.isNotEmpty && phoneNumber.length >= 6) {
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) =>
              PhoneVerificationCodeScreen(fullPhoneNumber: fullPhoneNumber),
        ),
      );
    } else {
                                                ...
                                                child: StatefulBuilder(
                                                  builder: (context, setState) {
                                                    ...
                                                    String formattedDialCode =
                                                        "( ${number.dialCode != null ? number.dialCode : "+1"} )";
